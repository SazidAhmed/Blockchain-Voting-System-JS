...
echo "  Task 2.1 (Vote Propagation):        bash tests/e2e/test-phase2-task2-1.sh"
echo "  Task 2.2 (Block Mining):            bash tests/e2e/test-phase2-task2-2.sh"
echo "  Task 2.3 (Chain Sync):              bash tests/e2e/test-phase2-task2-3.sh"
echo "  Task 2.4 (Network Recovery):        bash tests/e2e/test-phase2-task2-4.sh"
echo ""
