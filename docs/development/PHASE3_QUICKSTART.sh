...
echo -e "     ${GREEN}bash tests/e2e/test-phase3-task3-1.sh${NC}   # Tamper Detection"
echo -e "     ${GREEN}bash tests/e2e/test-phase3-task3-2.sh${NC}   # Historical Tampering"
echo -e "     ${GREEN}bash tests/e2e/test-phase3-task3-3.sh${NC}   # Double-Spend Prevention"
echo -e "     ${GREEN}bash tests/e2e/test-phase3-task3-4.sh${NC}   # 51% Attack Prevention"
echo -e "     ${GREEN}bash tests/e2e/test-phase3-task3-5.sh${NC}   # Sybil Attack Prevention"
echo ""
