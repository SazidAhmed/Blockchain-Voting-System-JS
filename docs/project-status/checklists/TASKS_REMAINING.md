...
- `services/frontend/src/views/VoteView.vue`
- `services/frontend/src/components/VoteReceipt.vue`
...
- `services/blockchain-node/src/core/block.js` - Add merkle root
- `services/blockchain-node/src/core/blockchain.js` - Generate proofs
- `services/blockchain-node/index.js` - Add verification endpoint
- `services/backend/routes/elections.js` - Include proof in receipt
- `services/frontend/src/components/VoteReceipt.vue` - Display proof
...
- `services/backend/package.json` - Add speakeasy, qrcode
- `services/backend/migrations/004_add_mfa.sql` - MFA columns
- `services/backend/routes/users.js` - MFA endpoints
- `services/backend/middleware/mfa.js` - MFA verification middleware
- `services/frontend/src/views/MFASetup.vue` - Setup page
- `services/frontend/src/views/LoginView.vue` - Add TOTP field
- `services/frontend/src/views/VoteView.vue` - Add MFA verification
...
- `services/blockchain-node/consensus/pbft.js` - PBFT engine
- `services/blockchain-node/consensus/messages.js` - Message types
- `services/blockchain-node/consensus/validator.js` - Validator logic
- `services/blockchain-node/src/core/blockchain.js` - Update consensus logic
- `services/blockchain-node/start-validators.sh` - Multi-node startup
- `services/blockchain-node/config/node1.env` - Node configs
- `services/blockchain-node/config/node2.env`
- `services/blockchain-node/config/node3.env`
- `services/blockchain-node/config/node4.env`
...
- `services/backend/package.json` - Add blind-signatures
- `services/backend/utils/blindSignature.js` - Blind sig logic
- `services/backend/routes/users.js` - Token endpoints
- `services/frontend/package.json` - Add blind-signatures
- `services/frontend/src/services/blindToken.js` - Client-side token
- `services/frontend/src/services/crypto.js` - Update nullifier
- `services/backend/routes/elections.js` - Verify token proof
...
- `services/backend/package.json` - Add threshold crypto lib
- `services/backend/services/dkg.js` - DKG ceremony
- `services/backend/services/tally.js` - Tallying service
- `services/backend/migrations/005_threshold_keys.sql` - Schema
- `services/blockchain-node/services/keyShare.js` - Share management
- `services/frontend/src/services/crypto.js` - Threshold encryption
- `services/backend/scripts/generate-election-keys.js` - Update to DKG
...
- `services/backend/package.json` - Add passport, passport-oauth2
- `services/backend/config/oauth.js` - OAuth2 configuration
- `services/backend/routes/auth.js` - OAuth2 endpoints
- `services/backend/services/mockIdP.js` - Mock IdP server
- `services/frontend/src/views/LoginView.vue` - Add OAuth2 button
...
- `services/backend/tests/load/voting-load.yml` - Artillery config
- `services/backend/tests/load/report.md` - Performance report
- `services/backend/config/db.js` - Connection pooling
- `services/backend/package.json` - Add Redis for caching
...
- `services/backend/package.json` - Add AWS SDK or Azure SDK
- `services/backend/config/hsm.js` - HSM configuration
- `services/backend/services/hsm.js` - HSM operations
- `services/blockchain-node/services/hsmSigner.js` - HSM signing
- `services/backend/scripts/generate-election-keys.js` - Use HSM
...
- `services/blockchain-node/governance/proposals.js` - Proposal system
- `services/blockchain-node/governance/voting.js` - Voting logic
- `services/blockchain-node/governance/evidence.js` - Evidence system
- `services/backend/routes/governance.js` - Governance API
- `services/frontend/src/views/admin/Governance.vue` - Admin UI
- `services/backend/migrations/006_governance.sql` - Governance tables
