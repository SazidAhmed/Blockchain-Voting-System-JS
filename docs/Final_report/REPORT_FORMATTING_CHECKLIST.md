...
- [ ] Acknowledgement page is included.
- [ ] Abstract is 150-300 words and includes 4-8 keywords.
- [ ] Table of contents is auto-generated.
- [ ] List of figures and list of tables are auto-generated.
...
- [ ] Line spacing follows guideline (commonly 1.5).
- [ ] Body font and size follow guideline (commonly Times New Roman, 12 pt).
...
- [ ] Diagram labels are readable in print (not blurry).
...
- [ ] Internal project files are cited as project artifacts where needed.
...
- [ ] Supervisor-required forms attached.
- [ ] Filename uses university naming convention.
