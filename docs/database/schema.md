...
**Indexes:** `election_id`, `display_order`
...
**Indexes:** `token_id_hash`, `pseudonym_id`, `election_id`, `revoked`
...
**Indexes:** `user_id`, `election_id`, `status`
...
**Indexes:** `tx_hash`, `election_id`, `nullifier_hash`, `block_index`, `timestamp`, `signature` (first 64 chars)
...
**Indexes:** `node_id`, `status`, `node_type`, `last_seen`
...
**Indexes:** `event_type`, `event_category`, `user_id`, `timestamp`, `severity`, `log_hash`
...
**Indexes:** `admin_id`, `action_type`, `resource_type`, `timestamp`
...
**Indexes:** `admin_id`, `event_type`, `severity`, `timestamp`
